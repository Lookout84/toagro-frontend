...
const HomePage = () => {
  ...
  const { categories, listings } = useAppSelector((state) => state.catalog);
  ...
  useEffect(() => {
    ...
    dispatch(fetchListings({ sortBy: 'createdAt', sortOrder: 'desc', limit: 8 }))
      .unwrap()
      .then((result) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-green-50 to-white rounded-xl p-8 mb-12">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-gray-600 mb-6">
            ToAgro — найбільший маркетплейс сільськогосподарської техніки та запчастин в Україні
          </p>
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Нові та вживані трактори провідних виробників</p>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600">Зернозбиральні та інші комбайни для вашого господарства</p>
          </Link>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Запчастини</h3>
            </div>
            <p className="text-gray-600">Оригінальні та аналогові запчастини для сільгосптехніки</p>
          </Link>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Ґрунтообробка</h3>
            </div>
            <p className="text-gray-600">Плуги, культиватори та інша техніка для обробки ґрунту</p>
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 mb-12">
        <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Чому варто вибрати ToAgro</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Найбільший вибір в Україні</h3>
            <p className="text-gray-600">Тисячі оголошень сільськогосподарської техніки та запчастин від перевірених продавців</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Безпечні угоди</h3>
            <p className="text-gray-600">Перевірені продавці, безпечні платежі та система рейтингів для вашого спокою</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Спільнота фермерів</h3>
            <p className="text-gray-600">Приєднуйтесь до спільноти фермерів та аграріїв - разом ми сильніші</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-green-600 text-white rounded-xl p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">Готові продати свою техніку?</h2>
        <p className="text-lg mb-6">Розмістіть оголошення безкоштовно та знайдіть покупця швидко!</p>
        <Link
          to="/listings/create"
